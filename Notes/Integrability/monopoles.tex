...
To get $h,\underline{h}$, we let $C_0, C_\infty$ be small circular contours around $\zeta=0,\infty$ respectively. then \hl{(...ask Harry what is going on...)} we get 
\eq{
\Delta_0 &= r^{-1} \sinh r 
}
From this we can reconstruct the hedgehog solution found by Prasad \& Sommerfeld of 
\eq{
