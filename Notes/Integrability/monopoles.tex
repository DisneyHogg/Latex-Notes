...
for some normalisable volume form on $S_t$. Then \hl{NOT COMPLETE}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
&= \int_{\mbb{R}^3} \abs{F-\star D\phi}^2 d^3x  \pm 2 \lim_{R \to \infty} \int_{S_R^2} \pangle{F \wedge \phi}
}
Then as 
\eq{
\highlight{\int_{\del M} \pangle{F,\phi} = - \int_{\del M} \pangle{\phi, d\phi \wedge d\phi}}
}
...
\begin{remark}
	\hl{The last step, getting the topological degree, I am not fully happy with yet. Ask Harry about this.}
\end{remark}
\begin{remark}
