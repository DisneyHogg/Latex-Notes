...
\end{remark}
As we can get onto other sheets just by multiplying $y$ by powers of $\zeta$, we get that the period matrix is 
\eq{
\Omega = \begin{pmatrix} (1-\zeta)B\pround{\frac{1}{2}, \frac{1}{6}} & \zeta^{-15} (1-\zeta)B\pround{\frac{1}{2}, \frac{1}{6}} & -\zeta^{-10} (1-\zeta)B\pround{\frac{1}{2}, \frac{1}{6}} & -\zeta^{-25} (1-\zeta)B\pround{\frac{1}{2}, \frac{1}{6}} \\ (1-\zeta)B\pround{\frac{1}{2}, \frac{1}{3}} & \zeta^{-12} (1-\zeta)B\pround{\frac{1}{2}, \frac{1}{3}} & -\zeta^{-8} (1-\zeta)B\pround{\frac{1}{2}, \frac{1}{3}} & -\zeta^{-20} (1-\zeta)B\pround{\frac{1}{2}, \frac{1}{3}}\end{pmatrix}
}
We can calculate 
\eq{
...
and so 
\eq{
\Omega \propto \begin{pmatrix} \sqrt{3} & -\sqrt{3} &  -\sqrt{3}\zeta^2  & -\sqrt{3}\zeta^5 \\ 1 & 1 & -\zeta^4 & -\zeta^4 \end{pmatrix}
}
This means we can calculate the Riemann matrix to be 
\eq{
R = \frac{1}{2\sqrt{3}}\begin{pmatrix} 1 & \sqrt{3} \\ -1 & \sqrt{3} \end{pmatrix} \begin{pmatrix} -\sqrt{3}\zeta^2 & - \sqrt{3} \zeta^5 \\ -\zeta^4 & -\zeta^4 \end{pmatrix} &= \frac{1}{2\sqrt{3}}\begin{pmatrix} -\sqrt{3}(\zeta^4+\zeta^2) & -\sqrt{3}(\zeta^4+\zeta^5) \\ \sqrt{3}(\zeta^2 - \zeta^4) & \sqrt{3}(\zeta^5-\zeta^4) \end{pmatrix}\\
 &= \frac{1}{2}\begin{pmatrix} -(\zeta^4+\zeta^2) & (\zeta^2-\zeta^4) \\ (\zeta^2 - \zeta^4) & -(\zeta^4+\zeta^2) \end{pmatrix} \\
  &= \frac{1}{2}\begin{pmatrix} 1 & \sqrt{3}i \\ \sqrt{3}i & 1 \end{pmatrix}
}
\hl{Eigenvalues do not have pos-def imaginary part, what's gone wrong?}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Spinors}
