...
\eq{
	...
	\frac{d}{ds}(\alpha + \alpha^\dagger) - \pround{\comm[\alpha]{\alpha^\dagger} + \comm[\beta]{\beta^\dagger}} &= 0 \quad \text{(the \bam{real equation})}
}
...
\begin{lemma}
	...
	\eq{
\alpha &\mapsto g\alpha g^{-1} + \frac{dg}{ds}g^{-1} \\
\beta &\mapsto g\beta g^{-1}	
}
\end{lemma}
