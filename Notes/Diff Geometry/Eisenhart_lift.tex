...
&= \psquare{h^{ij}\pd[X^k]{x^i}\pd[X^l]{x^j}}\tilde{\del}_k \otimes \tilde{\del}_l -\psquare{h^{ij}N_j \pd[X^k]{x^i}-h^{ij}\pd[X^k]{x^i}\pd[V]{x^j}-\pd[X^k]{t}}(\tilde{\del}_k \otimes \tilde{\del}_v + \tilde{\del}_v \otimes \tilde{\del}_k) +(\tilde{\del}_t \otimes \tilde{\del}_v + \tilde{\del}_v \otimes \tilde{\del}_t) \\
...
\eq{
	...
	\tilde{h}^{kl}\tilde{N}_l &= h^{ij}N_j \pd[X^k]{x^i}-h^{ij}\pd[X^k]{x^i}\pd[V]{x^j}-\pd[X^k]{t} \\
