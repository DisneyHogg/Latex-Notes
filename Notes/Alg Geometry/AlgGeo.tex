...
so we need to swap the differentials (that is $\omega_1^\prime = \omega_2$ and $\omega_2^\prime = \omega_1$) as now $(r^\prime)^\ast \omega_2 = \omega_2, \, (r^\prime)^\ast \omega_1 = -\omega_1$. This yields 
\eq{
