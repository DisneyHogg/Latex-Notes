...
\begin{theorem}
	...
	\eq{
\ind(D^+) = \int_N \det \pround{\frac{\sfrac{\mc{R}}{2}}{\sinh \sfrac{\mc{R}}{2}}}	
}
...
\eq{
I_w = \ind(D^+) &= \int \prod_{i=1}^m \frac{\pround{\sfrac{\omega_i}{2}}}{\sinh\pround{\sfrac{\omega_i}{2}}} \\
&= \int \det \pround{\frac{\sfrac{\mc{R}\indices{^a_b}(x_0,\psi_0)}{2}}{\sinh\pround{\sfrac{\mc{R}\indices{^a_b}(x_0,\psi_0)}{2}}}} \, d^nx_0 \, d^n\psi_0 \\
&= \int_N \det \pround{\frac{\sfrac{\mc{R}}{2}}{\sinh \sfrac{\mc{R}}{2}}}
}
\end{proof}  
