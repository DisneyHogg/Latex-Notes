...
\eq{
S^{(2)}[x_0, \psi_0, \delta x, \delta \psi] = \oint - \frac{1}{2} \delta x_a \frac{d^2}{dt^2} \delta x^a + \frac{1}{2} \delta \psi_a \frac{d}{d\tau} \delta \psi^a - \frac{1}{4} R_{abcd} \psi_0^a \psi_0^b \delta x^c \delta \dot{x}^d \, d\tau
}
