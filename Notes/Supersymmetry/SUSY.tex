...
where
\eq{
\eta \in \Omega^{(p,q)}(M) \Leftrightarrow \eta(z,\bar{z}) = \eta_{a_1 \dots a_p \bar{b}_1 \dot \bar{b}_q}(z,\bar{z}) \, dz^{a_1} \wedge \dots \wedge dz^{a_p} \wedge d\bar{z}^{\bar{b}_1} \wedge \dots \wedge d\bar{z}^{\bar{b}_q}
}
