...
\begin{prop}
	We have 
	\eq{
\sdet \psquare{\begin{pmatrix} A & B \\ C & D \end{pmatrix}} = 
}
\end{prop}
\begin{proof}
...
However, suppose we choose a polynomial $W(x)$ and take $S(x,\psi) = \frac{1}{2} (\del W)^2 - \bar{\psi} \psi \del^2 W$ (taking $\psi = \psi^1 + i \psi^2, \bar{\psi} = \psi^1 -i \psi^2$). 
\begin{lemma}
