The following set of files are notes and documents I have worked on during my time of my PhD, and earlier.
My hope is to extend the use of the Notes directory to allow people who read my notes to suggest updates.
There is no personal data which needs protecting, so you are free to read at your own leisure. 
...
header.sty
This is my big header file that I use in almost all my Latex documents. 
